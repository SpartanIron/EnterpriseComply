...
return `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><style>body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f9fafb;margin:0;padding:0;color:#111}.container{max-width:600px;margin:40px auto;background:#fff;border-radius:8px;padding:40px;border:1px solid #e5e7eb}.logo{font-size:20px;font-weight:700;color:#1d4ed8;margin-bottom:24px}.btn{display:inline-block;padding:12px 24px;background:#1d4ed8;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;margin:16px 0}.footer{margin-top:32px;font-size:12px;color:#6b7280;border-top:1px solid #e5e7eb;padding-top:16px}h2{font-size:22px;margin:0 0 16px}p{line-height:1.6;margin:0 0 12px}</style></head><body><div class="container"><div class="logo">EnterpriseComply</div>${body}<div class="footer">EnterpriseComply &mdash; GRC for the Enterprise &bull; <a href="${BASE_URL}">${BASE_URL.replace("https://","")}</a></div></div></body></html>`;
}
