...
//
// The invite email points here with ?org=<id>&token=<secret>. The token is the
// credential, so it is posted to the API immediately and then stripped from the
// address bar so it does not linger in browser history or a referrer header.
//
        ...
        {phase === "failed" && (
          <>
            ...
            <p className="text-xs text-slate-500">
              Invitation links expire after seven days and can only be used once. Ask whoever
