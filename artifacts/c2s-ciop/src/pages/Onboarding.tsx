...
const FRAMEWORKS = [
  ...
  { key: "cmmc-l2", name: "CMMC Level 2", category: "federal" }, { key: "cmmc-l1", name: "CMMC Level 1", category: "federal" },
...
const FRAMEWORK_COLORS: Record<string, string> = {
  ...
  "cmmc-l2": "from-green-500 to-green-600", "cmmc-l1": "from-green-400 to-green-500",
