    ...
    <div className="p-6 max-w-screen-xl">
      <div className="flex items-start justify-between mb-6">
        ...
        <a href="https://www.nist.gov/system/files/documents/2021/11/01/NIST%20SP%20800-171%20DoD%20Assessment%20Methodology%20Version%201.2.1%20September%202020.pdf"
          ...
          className="text-xs text-green-800 hover:underline">DoD Methodology PDF</a>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden mb-6">
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs font-semibold text-green-800 hover:text-green-700 flex items-center gap-1"
          >
