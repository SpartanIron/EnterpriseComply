      ...
      <div className="min-h-screen flex items-center justify-center" style={{ background: "#f1f5f9" }}>
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 text-center">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-1">We sent a secure sign-in link to</p>
            <p className="text-sm font-semibold text-slate-800 mb-4">{email}</p>
            <p className="text-xs text-slate-400 mb-5">The link expires in 15 minutes. No password needed.</p>
            <button
    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#f1f5f9" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          <form onSubmit={handleMagicLink} className="px-7 pb-6 space-y-3">
            {tab === "signup" && (
              <div>
          ...
          <div className="px-7 pb-7">
            <div className="relative flex items-center gap-3 mb-4">
              ...
              <span className="text-xs text-slate-400 font-medium flex-shrink-0">or</span>
              <div className="flex-1 h-px bg-slate-200" />
            </div>
            <button
              type="button"
