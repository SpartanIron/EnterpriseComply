...
const MOCK_VULNS = [
  { id: "V-001", cveId: "CVE-2024-1234", title: "Critical Remote Code Execution in OpenSSL", severity: "Critical", cvss: 9.8, source: "Tenable.io", sourceId: "TNS-2024-1234", affectedAsset: "prod-web-01, prod-web-02", component: "OpenSSL 3.1.2", status: "open", slaDeadline: "2026-06-01", assignee: "Alice Johnson", discoveredAt: "2026-05-01", dueDate: "2026-06-01", daysRemaining: -5, framework: "FedRAMP High RA-5", duplicateOf: null, poamRef: "POA-2024-047" },
  { id: "V-002", cveId: "CVE-2024-5678", title: "Privilege Escalation in Linux Kernel", severity: "High", cvss: 8.1, source: "Qualys", sourceId: "QID-198732", affectedAsset: "k8s-node-01, k8s-node-02, k8s-node-03", component: "Linux Kernel 5.15", status: "in_remediation", slaDeadline: "2026-06-15", assignee: "Bob Williams", discoveredAt: "2024-11-05", dueDate: "2026-06-15", daysRemaining: 10, framework: "CMMC RM.L2-3.11.2", duplicateOf: null, poamRef: null },
  { id: "V-003", cveId: "CVE-2024-9012", title: "Authentication Bypass in Apache HTTP Server", severity: "High", cvss: 7.5, source: "Wiz", sourceId: "WIZ-2024-9012", affectedAsset: "api-gateway-prod", component: "Apache httpd 2.4.51", status: "open", slaDeadline: "2026-06-15", assignee: "Carol Davis", discoveredAt: "2024-11-10", dueDate: "2026-06-15", daysRemaining: 10, framework: "FedRAMP Moderate RA-5", duplicateOf: null, poamRef: null },
  { id: "V-004", cveId: "CVE-2024-3456", title: "SQL Injection in Customer API Endpoint", severity: "High", cvss: 7.2, source: "Veracode", sourceId: "VRC-4892-A", affectedAsset: "api-server-prod", component: "customer-api v2.3.1", status: "open", slaDeadline: "2026-06-15", assignee: "David Lee", discoveredAt: "2024-11-12", dueDate: "2026-06-15", daysRemaining: 10, framework: "CMMC SA.L3-3.12.1", duplicateOf: null, poamRef: "POA-2024-048" },
  { id: "V-005", cveId: "CVE-2024-7890", title: "Cross-Site Scripting in Dashboard UI", severity: "Medium", cvss: 5.4, source: "Snyk", sourceId: "SNYK-JS-4521", affectedAsset: "app.enterprisecomply.com", component: "react-dom 18.2.0", status: "in_remediation", slaDeadline: "2026-07-14", assignee: "Eve Martinez", discoveredAt: "2024-11-15", dueDate: "2026-07-14", daysRemaining: 40, framework: "SOC 2 CC7.2", duplicateOf: null, poamRef: null },
  { id: "V-006", cveId: "CVE-2024-1122", title: "Information Disclosure in Error Responses", severity: "Medium", cvss: 4.3, source: "Checkmarx", sourceId: "CXF-2024-1122", affectedAsset: "api-server-prod", component: "nestjs 10.x", status: "open", slaDeadline: "2026-07-14", assignee: null, discoveredAt: "2024-11-18", dueDate: "2026-07-14", daysRemaining: 40, framework: "NIST 800-53 SI-10", duplicateOf: null, poamRef: null },
  { id: "V-007", cveId: "CVE-2024-4433", title: "Insecure Direct Object Reference in File API", severity: "Medium", cvss: 6.5, source: "Orca Security", sourceId: "ORC-2024-4433", affectedAsset: "file-service-prod", component: "express 4.18.1", status: "accepted_risk", slaDeadline: "2026-07-14", assignee: "Alice Johnson", discoveredAt: "2024-11-08", dueDate: "2026-07-14", daysRemaining: 40, framework: "FedRAMP Moderate", duplicateOf: null, poamRef: null },
  { id: "V-008", cveId: "CVE-2024-2211", title: "Dependency Confusion Attack Surface", severity: "Low", cvss: 3.1, source: "Snyk", sourceId: "SNYK-JS-8811", affectedAsset: "build-pipeline", component: "npm registry", status: "closed", slaDeadline: "2026-09-14", assignee: "Frank Thompson", discoveredAt: "2026-04-20", dueDate: "2026-09-14", daysRemaining: 99, framework: "CMMC CM.L2-3.4.9", duplicateOf: null, poamRef: null },
  { id: "V-009", cveId: "CVE-2024-3322", title: "Container Escape via Privileged Container", severity: "Critical", cvss: 9.1, source: "CrowdStrike Falcon", sourceId: "CS-2024-3322", affectedAsset: "k8s-prod-cluster", component: "Docker runtime", status: "open", slaDeadline: "2026-06-01", assignee: "Bob Williams", discoveredAt: "2024-11-20", dueDate: "2026-06-01", daysRemaining: -5, framework: "FedRAMP High CM-6", duplicateOf: null, poamRef: "POA-2024-049" },
];
